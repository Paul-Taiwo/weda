...
const HeavyRainNightIcon = () => {
    return (
        ...
        >
            <path
                d="M172.613 200.467C176.526 200.511 216.226 262.496 216.226 286.583C216.226 298.15 211.631 309.243 203.452 317.422C195.273 325.601 184.18 330.196 172.613 330.196C161.046 330.196 149.953 325.601 141.774 317.422C133.595 309.243 129 298.15 129 286.583C129 262.496 168.7 200.424 172.613 200.467Z"
                fill="#42A0F0"
            />
            <path
                d="M139.36 302.886C143.717 304.219 149.256 298.738 151.73 290.644C154.205 282.551 152.678 274.91 148.32 273.578C143.962 272.245 138.424 277.726 135.949 285.82C133.475 293.913 135.002 301.554 139.36 302.886Z"
                fill="white"
            />
            <path
                d="M275.359 282.209C277.824 282.238 302.839 321.293 302.839 336.47C302.795 343.73 299.881 350.677 294.732 355.795C289.583 360.913 282.618 363.785 275.358 363.785C268.099 363.785 261.134 360.913 255.985 355.795C250.836 350.677 247.922 343.73 247.878 336.47C247.878 321.293 272.893 282.182 275.359 282.209Z"
                fill="#42A0F0"
            />
            <path
                d="M254.406 346.743C257.152 347.582 260.642 344.129 262.201 339.03C263.76 333.93 262.798 329.116 260.052 328.276C257.306 327.437 253.816 330.89 252.257 335.989C250.698 341.089 251.66 345.903 254.406 346.743Z"
                fill="white"
            />
            <path
                ...
                fill="#713FFD"
            />
            <g filter="url(#filter0_f_131_500)">
                <path
            ...
            <g filter="url(#filter1_d_131_500)">
                <path
                    ...
                    fill="url(#paint0_radial_131_500)"
                    fillOpacity="0.8"
                />
                <path
                    ...
                    fill="url(#paint1_linear_131_500)"
                />
            </g>
            <defs>
                <filter
                    id="filter0_f_131_500"
                    x="77.9736"
                    y="0.0932617"
                    width="138.879"
                    height="135.194"
                ...
                >
                    ...
                    <feBlend
                        ...
                        result="shape"
                    />
                    <feGaussianBlur stdDeviation={10} result="effect1_foregroundBlur_131_500" />
                </filter>
                <filter
                    id="filter1_d_131_500"
                    x={19}
                    y={33}
                    width="413.346"
                    height={281}
                ...
                >
                    ...
                    <feBlend
                        mode="normal"
                        in2="BackgroundImageFix"
                        result="effect1_dropShadow_131_500"
                    />
                    <feBlend
                        mode="normal"
                        in="SourceGraphic"
